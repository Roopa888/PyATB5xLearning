...
def test_windows_handlers():
    ...
    print(
        window_handles1)  # now 2 tabs are there .So handles ID will be printed-->['7F441BBEB1CA21FDCED1F9281C9F3027', 'A32D50812A655E46209FEFA24E9466A7']
    for handle in window_handles1:
        driver.switch_to.window(handle)
        if "New Window" in driver.page_source:
            print("Test case passed-Switched to New window")
            break
    time.sleep(5)
    driver.quit()
