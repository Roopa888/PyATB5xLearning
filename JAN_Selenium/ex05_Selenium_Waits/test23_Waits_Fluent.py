...
def test_app_vwo_com_login_fluent_wait():
    ...
    WebDriverWait(driver=driver,timeout=3,poll_frequency=1,ignored_exceptions=ignore_list).until(EC.visibility_of_element_located((By.ID,"js-notification-box-msg")))
